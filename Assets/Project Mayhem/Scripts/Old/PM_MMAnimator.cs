...
namespace MoreMountains.Tools ///// - Eman - Update Namespaces so ExtensionMethods is read. PM.Tools 
{	
	/// <summary>
	/// Various static methods used throughout the Infinite Runner Engine and the Corgi Engine.
	/// </summary>

	public static class PM_MMAnimator
	{
		/// <summary>
		...
		/// param: SpriteAnim, EventName, Boolvalue. Recreat this function so it works with Sprite Factory. Value is equal to control state.
